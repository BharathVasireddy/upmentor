      ...
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mx-auto max-w-2xl text-gray-600">
            Help us understand your career aspirations, interests, and
            challenges so we can match you with the perfect mentors.
          </p>
        </div>
        ...
        <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-3 md:grid-cols-3">
                {careerGoals.map(goal => (
                  <Badge
                    key={goal.id}
                    variant={
                      selectedGoals.includes(goal.id) ? 'default' : 'outline'
                    }
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Share any specific concerns or additional information that would
                help mentors understand you better
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Textarea
